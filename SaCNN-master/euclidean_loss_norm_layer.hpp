...
#ifndef CAFFE_EUCLIDEAN_LOSS_NORM_LAYER_HPP_
#define CAFFE_EUCLIDEAN_LOSS_NORM_LAYER_HPP_
...
class EuclideanLossNormLayer : public LossLayer<Dtype> {
 public:
  explicit EuclideanLossNormLayer(const LayerParameter& param)
